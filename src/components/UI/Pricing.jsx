      ...
      <div className="container">
        <div className="pricing__top">
          <h2 className="section__title">
            Gym <span className="highlights">Pricing</span> pack
          </h2>
          <p>
          The costs can be higher if you go for advanced training such as <br></br>cross fit, cardio, aerobics, pilates, and rope workouts.
          </p>
        </div>
